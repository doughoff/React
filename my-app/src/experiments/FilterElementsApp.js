...
const Filter = (props) => {
  ...
  let re = new RegExp(reStr, "gi"); // construct the regular expression, global, case insensitive


  let sentencesWithKeyword = []; // initialize an array to keep the hits
  let arr; // prepare an array to temporarily keep 'exec' return values
  let expandedText = ". " + text + " A";
